...
import GameFileIndividualFile from './GameFileIndividualFile';
...
export default class GameFileUploadComponent extends Component {
  constructor(props) {
    super(props);
  ...
  uploadIt(e) {
    ...
    if (e.currentTarget.files && e.currentTarget.files[0]) {
      ...
      if (file) {
        let uploadInstance;
        if(self.props.id){
           uploadInstance = GameFiles.insert({
          file: file,
          meta: {
            id:self.props.id,
...
GameFileUploadComponent.propTypes = {
  id:PropTypes.string,
};
